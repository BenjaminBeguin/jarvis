    ...
    <div className="settings__section">
      ...
      <ul className="settings__concept-list">
        ...
        <li>
          ...
          skill, viewable in the Briefings tab. Each kind = one skill +
          one routine. NOT a module — closer in shape to "inbox source"
          but the output is human-readable prose, not action items.
        </li>
      </ul>
    </div>
  );
