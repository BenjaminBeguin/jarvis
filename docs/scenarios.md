...
## Briefings (planned, not built yet)
...
This is a separate concept — markdown output, viewable in a Briefings
tab, generated by skills that pull from meetings + Linear + Slack +
notes. See docs/NEXT.md for the design sketch.
